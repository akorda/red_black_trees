...
\centering
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
...
\subsubsection{Case 1: Red uncle --- Propagation mechanism}
...
\subsubsection{Case 2: Black uncle --- Rebalance mechanism}
...
which is the right child of its parent, node \encircle{2} Figure~\ref{fig:case_2_1_violation}.
...
Upon completion of this operation, node \encircle{7} becomes the new root, 
and no new violation exists, 
since the root of the sub-tree under consideration is connected by a \emph{BLACK} link.
...
\subsection{Case D.1. \emph{BLACK} sibling with a right \emph{RED} child}

See the Figure~\ref{fig:deletion_case_1_problem}, or maybe Figure~\ref{fig:deletion_case_1}.
...
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (p) [label=left:h] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2]at (-1.50, -1.50) {v};
    \node (s) [label=left:h+1]at (2.00, -1.50) {s};
    \node (s2) [label=left:h+1/h+2]at (1.00, -2.25) {s2};
    \node (z) [label=right:h+1] at (3.50, -1.50) {z};
    \node (z1) [label=left:h+2] at (2.75, -3.00) {z1};
    \node (z2) [label=right:h+2] at (4.25, -3.00) {z2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              red_black_edge/.style={draw=green,very thick},
              black_edge/.style={draw=black,very thick},
              double_black_edge/.style={draw=black,thick}]
    \path [->] (p) edge [double distance=2pt, double_black_edge] (v);
    \path [->] (p) edge [black_edge] (s);
    \path [->] (s) edge [red_edge] (z);
    \path [->] (s) edge [red_black_edge] (s2);
    \path [->] (z) edge [black_edge] (z1);
    \path [->] (z) edge [black_edge] (z2);
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.1}}
\label{fig:deletion_case_1_problem}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (s) [label=left:h] at (0.00, 0.00) {s};
    \node (p) [label=left:h+1]at (-2.00, -1.50) {p};
    \node (z) [label=right:h+1] at (2.00, -1.50) {z};
    \node (v) [label=left:h+2] at (-3.00, -3.00) {v};
    \node (s2) [label=right:h+1/h+2] at (-1.00, -2.25) {s2};
    \node (z1) [label=left:h+2] at (0.75, -3.00) {z1};
    \node (z2) [label=right:h+2] at (3.25, -3.00) {z2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              red_black_edge/.style={draw=green,very thick},
              black_edge/.style={draw=black,very thick}]
    \path [->] (s) edge [black_edge] (p);
    \path [->] (p) edge [black_edge] (v);
    \path [->] (z) edge [black_edge] (z1);
    \path [->] (s) edge [black_edge] (z);
    \path [->] (p) edge [red_black_edge] (s2);
    \path [->] (z) edge [black_edge] (z2);
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.1}}
\label{fig:deletion_case_1_fix}
\end{subfigure}
\caption{\emph{Case D.1}: \emph{BLACK} sibling with a right \emph{RED} child}
\label{fig:deletion_case_1}
\end{figure}

\subsection{Case D.2. \emph{BLACK} sibling with a left \emph{RED} child}
...
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (p) [label=left:h] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2]at (-1.50, -1.50) {v};
    \node (s) [label=right:h+1]at (2.50, -1.50) {s};
    \node (s2) [label=right:h+1/h+2]at (3.50, -2.25) {s2};
    \node (z) [label=left:h+1] at (1.00, -1.50) {z};
    \node (z1) [label=left:h+2] at (0.25, -3.00) {z1};
    \node (z2) [label=right:h+2] at (1.75, -3.00) {z2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
...
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.2}}
\label{fig:deletion_case_2_problem}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (z) [label=left:h] at (0.00, 0.00) {z};
    \node (p) [label=left:h+1]at (-2.00, -1.50) {p};
    \node (s) [label=right:h+1] at (2.00, -1.50) {s};
    \node (v) [label=left:h+2] at (-3.00, -3.00) {v};
    \node (s2) [label=right:h+1/h+2] at (3.50, -2.25) {s2};
    \node (z1) [label=right:h+2] at (-1.00, -3.00) {z1};
    \node (z2) [label=right:h+2] at (1.00, -3.00) {z2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              red_black_edge/.style={draw=green,very thick},
              black_edge/.style={draw=black,very thick}]
    \path [->] (z) edge [black_edge] (p);
    \path [->] (p) edge [black_edge] (v);
    \path [->] (p) edge [black_edge] (z1);
    \path [->] (z) edge [black_edge] (s);
    \path [->] (s) edge [red_black_edge] (s2);
    \path [->] (s) edge [black_edge] (z2);
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.2}}
\label{fig:deletion_case_2_fix}
\end{subfigure}
\caption{\emph{Case D.2}: \emph{BLACK} sibling with a left \emph{RED} child}
\label{fig:deletion_case_2}
\end{figure}

\subsection{Case D.3. \emph{BLACK} sibling with \emph{BLACK} children and \emph{RED} parent}
...
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (r) [label=right:h] at (1.50, 0.00) {};
    \node (p) [label=left:h] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2]at (-1.50, -1.50) {v};
    \node (s) [label=right:h+1] at (1.00, -1.50) {s};
    \node (s1) [label=left:h+2] at (0.25, -3.00) {s1};
    \node (s2) [label=right:h+2] at (1.75, -3.00) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              ...
              black_edge/.style={draw=black,very thick},
              double_black_edge/.style={draw=black,thick}]
    \path [->] (r) edge [red_edge] (p);
    \path [->] (p) edge [double distance=2pt, double_black_edge] (v);
    \path [->] (p) edge [black_edge] (s);
    \path [->] (s) edge [black_edge] (s1);
    \path [->] (s) edge [black_edge] (s2);
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.3}}
\label{fig:deletion_case_3_problem}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (r) [label=left:h] at (1.00, 1.50) {};
    \node (p) [label=left:h+1] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2] at (-1.50, -1.50) {v};
    \node (s) [label=right:h+1] at (2.00, 0.00) {s};
    \node (s1) [label=left:h+2] at (0.75, -1.50) {s1};
    \node (s2) [label=right:h+2] at (3.25, -1.50) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              ...
              black_edge/.style={draw=black,very thick},
              double_black_edge/.style={draw=black,thick}]
    \path [->] (r) edge [black_edge] (p);
    \path [->] (p) edge [black_edge] (v);
    \path [->] (p) edge [red_edge] (s);
    \path [->] (s) edge [black_edge] (s1);
    \path [->] (s) edge [black_edge] (s2);
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.3}}
\label{fig:deletion_case_3_fix}
\end{subfigure}
\caption{\emph{Case D.3}: \emph{BLACK} sibling with \emph{BLACK} children and \emph{RED} parent}
\label{fig:deletion_case_3}
\end{figure}

\subsection{Case D.4. \emph{BLACK} sibling with \emph{BLACK} children and parent}
...
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (r) [label=left:h] at (1.00, 1.50) {};
    \node (p) [label=left:h+1] at (0.00, 0.00) {p};
    \node (v) [label=left:h+3]at (-1.50, -1.50) {v};
    \node (s) [label=right:h+1] at (1.00, -1.50) {s};
    \node (s1) [label=left:h+3] at (0.25, -3.00) {s1};
    \node (s2) [label=right:h+3] at (1.75, -3.00) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
...
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.4}}
\label{fig:deletion_case_4_problem}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (r) [label=left:h] at (1.00, 1.50) {};
    \node (p) [label=left:h+2] at (0.00, 0.00) {p};
    \node (v) [label=left:h+3] at (-1.50, -1.50) {v};
    \node (s) [label=right:h+2] at (2.00, 0.00) {s};
    \node (s1) [label=left:h+3] at (0.75, -1.50) {s1};
    \node (s2) [label=right:h+3] at (3.25, -1.50) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              ...
              black_edge/.style={draw=black,very thick},
              double_black_edge/.style={draw=black,thick}]
    \path [->] (r) edge [double distance=2pt, double_black_edge] (p);
    \path [->] (p) edge [black_edge] (v);
    \path [->] (p) edge [red_edge] (s);
    \path [->] (s) edge [black_edge] (s1);
    \path [->] (s) edge [black_edge] (s2);
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.4}}
\label{fig:deletion_case_4_fix}
\end{subfigure}
\caption{\emph{Case D.4}: \emph{BLACK} sibling with \emph{BLACK} children and parent}
\label{fig:deletion_case_4}
\end{figure}

\subsection{Case D.5. \emph{RED} sibling}
...
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (p) [label=left:h] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2]at (-1.50, -1.50) {v};
    \node (s) [label=right:h] at (2.00, -0.00) {s};
    \node (s1) [label=left:h+1] at (0.75, -1.50) {s1};
    \node (s2) [label=right:h+1] at (3.25, -1.50) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
...
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.5}}
\label{fig:deletion_case_5_problem}
\end{subfigure}
\begin{subfigure}[b]{0.5\textwidth}
\begin{tikzpicture}
\begin{scope}[every node/.style={circle, minimum size=14, inner sep=0, font=\small,thick,draw}]
    \node (p) [label=left:h] at (0.00, 0.00) {p};
    \node (v) [label=left:h+2] at (-1.00, -1.50) {v};
    \node (s) [label=right:h] at (2.25, 0.00) {s};
    \node (s1) [label=right:h+1] at (1.00, -1.50) {s1};
    \node (s2) [label=right:h+1] at (3.50, -1.50) {s2};
\end{scope}
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              ...
              double_black_edge/.style={draw=black,thick}]
    \path [->] (r) edge [] (s);
    \path [->] (s) edge [red_edge] (p);
    \path [->] (p) edge [double distance=2pt, double_black_edge] (v);
    \path [->] (p) edge [black_edge] (s1);
    \path [->] (s) edge [black_edge] (s2);
\end{scope}
\end{tikzpicture}
\caption{Handling of \emph{Case D.5}}
\label{fig:deletion_case_5_fix}
\end{subfigure}
\caption{\emph{Case D.5}: \emph{BLACK} sibling with \emph{BLACK} children and \emph{BLACK} parent}
\label{fig:deletion_case_5}
\end{figure}
...
\emph{BLACK}. In addition, the \texttt{Key} property of the \emph{Nil} node is set to the key used when searching.
\par
