...
\subsection{Case D.4. \emph{RED} sibling}
...
\end{subfigure}
\caption{\emph{Case D.4}: \emph{RED} sibling}
\label{fig:deletion_case_4}
\end{figure}

\subsection{Case D.5. \emph{BLACK} sibling with \emph{BLACK} children and parent}
...
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.5}}
\label{fig:deletion_case_5_fix}
\end{subfigure}
\caption{\emph{Case D.5}: \emph{BLACK} sibling with \emph{BLACK} children and parent}
