...
\begin{scope}[>={Stealth[black,length=3mm]},
              every node/.style={fill=white,circle},
              red_edge/.style={draw=red,very thick},
              brown_edge/.style={draw=brown,very thick},
              black_edge/.style={draw=black,very thick},
...
\begin{scope}[>={Stealth[black,length=3mm]},
    ...
    \path [->] (p) edge [brown_edge] (s2);
    \path [->] (z) edge [black_edge] (z2);
\end{scope}
\end{tikzpicture}
\caption{Fix of \emph{Case D.1}}
\label{fig:deletion_fix_of_case_1}
\end{figure}
...
\label{fig:deletion_fix_of_case_2}
\end{figure}
...
\label{fig:deletion_fix_of_case_3}
\end{figure}

\subsection{Case D.4. \emph{BLACK} sibling with \emph{BLACK} children and \emph{BLACK} parent}
...
\end{scope}
\end{tikzpicture}
\caption{\emph{Case D.4}: \emph{BLACK} sibling with \emph{BLACK} children and \emph{BLACK} parent}
...
\label{fig:deletion_fix_of_case_4}
\end{figure}
...
\label{fig:deletion_fix_of_case_5}
\end{figure}
